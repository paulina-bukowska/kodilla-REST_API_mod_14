...
public class TaskControllerTest {
    ...
    public void shouldFetchTask() throws Exception {
        ...
        //When & Then
            mockMvc.perform(get("/v1/tasks/13").contentType(MediaType.APPLICATION_JSON))
    ...
    public void shouldThrowException() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/v1/tasks/14").contentType(MediaType.APPLICATION_JSON));
    }
...
;
    ...
    public void shouldDeleteTask() throws Exception {
        ...
        // When & Then
        mockMvc.perform(delete("/v1/tasks/5").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
}
